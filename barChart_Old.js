...
d3.csv("Data/2016-2017/FundingVsAchievement.csv", type, function (error, data) {
    ...
    var legend = serie.append("g")
        .attr("class", "legend")
        .attr("transform", function (d) { var d = d[d.length - 1]; return "translate(" + (x(d.data.District) + x.bandwidth()) + "," + ((y(d[0]) + y(d[1])) / 2) + ")"; });
